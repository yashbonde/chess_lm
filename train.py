...
args.add_argument("--tf", type=str, choices=["train", "fine"],
...
args.add_argument("--m2id", type=str, default = None, help="path to move_to_id json")

args.add_argument("--maxlen", type = int, default = 60, help = "maximum length")
args.add_argument("--buffer", type = int, default = 55555, help = "buffer size for DataSet")
...
args.add_argument("--n_head", type = int, default = 2, help = "number of heads for MHA")

args.add_argument("--lr", type = int, default = 0.9, help = "learning rate")
...
trainer = Trainer(model, dstrain, dstest, trainerConf)
